    ...
    return (
        <section className="container contact pt-20 px-25">
            ...
            <p className="position-relative fs-14 my-20 px-50">
                <i class="color-primary fs-33  fa fa-envelope-open position-absolute" aria-hidden="true"></i>
            ...
            <p className="position-relative fs-14 px-50">
                <i class="color-primary fs-38  fa fa-phone-square position-absolute" aria-hidden="true"></i>
            ...
            <ul className="social mb-50">
                <li className="w-40 h-40 d-inline-block"><a href=""><i className="fa fa-github"></i></a></li>
                <li className="w-40 h-40 d-inline-block"><a href=""><i className="fa fa-linkedin"></i></a></li>
            </ul>
